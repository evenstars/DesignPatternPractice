...
public interface GenericListADTNode<T> {
   ...
   */
  GenericListADTNode<T> reverse(GenericListADTNode<T> last);
   ...
   */
  GenericListADTNode<T> interleave();
   ...
   */
  GenericListADTNode<T> collectEven(int index);
   ...
   */
  GenericListADTNode<T> merge(GenericListADTNode<T> back);
}